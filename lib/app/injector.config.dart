...
import 'injector.dart' as _i48;
import 'shop/domain/entities/auth.dart' as _i29;
import 'shop/domain/entities/auth_credentials.dart' as _i30;
...
import 'shop/domain/usecases/auth_usecases/auth_with_email.dart' as _i31;
import 'shop/domain/usecases/base_usecase/base_usecase.dart' as _i28;
...
import 'shop/domain/usecases/order_usecase/contracts/get_order_usecase_contract.dart'
    as _i39;
import 'shop/domain/usecases/order_usecase/get_orders_usecase.dart' as _i40;
import 'shop/domain/usecases/product_usecases/add_product.dart' as _i36;
...
import 'shop/domain/usecases/product_usecases/contracts/update_product_usecase_contract.dart'
    as _i26;
import 'shop/domain/usecases/product_usecases/delete_product.dart' as _i38;
import 'shop/domain/usecases/product_usecases/get_product.dart' as _i42;
import 'shop/domain/usecases/product_usecases/get_products_list.dart' as _i44;
...
import 'shop/presenter/auth/bloc/auth_bloc.dart' as _i32;
import 'shop/presenter/cart/bloc/cart_bloc.dart' as _i47;
import 'shop/presenter/product/bloc/product_bloc.dart' as _i45;
import 'shop/presenter/products_list/bloc/bloc/products_list_bloc.dart' as _i46;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i10.ICartDataSource>(() => _i11.FirebaseCartDatasource(
      get<_i5.Dio>(), get<_i4.SharedPreferences>()));
  ...
  gh.factory<_i16.IOrderDataSource>(() => _i17.FirebaseOrderDataSource(
      get<_i5.Dio>(), get<_i4.SharedPreferences>()));
  gh.factory<_i18.IOrderRepository>(
      () => _i19.OrderRepository(get<_i16.IOrderDataSource>()));
  gh.factory<_i20.IProductDataSource>(() => _i21.FirebaseProductDataSource(
      get<_i5.Dio>(), get<_i4.SharedPreferences>()));
  ...
  gh.factory<_i28.UseCase<_i29.Auth, _i30.AuthCredentials>>(() =>
      _i31.AuthWithEmail(
          get<_i8.IAuthRepository>(), get<_i4.SharedPreferences>()));
  gh.factory<_i32.AuthBloc>(() => _i32.AuthBloc(
      usecase: get<_i28.UseCase<_i29.Auth, _i30.AuthCredentials>>()));
  gh.factory<_i33.IAddOrUpdateCartUseCase>(
      () => _i34.AddOrUpdateCartUseCase(get<_i12.ICartRepository>()));
  gh.factory<_i35.IAddProductUseCase>(
      () => _i36.AddProductUseCase(get<_i22.IProductRepository>()));
  gh.factory<_i37.IDeleteProductUseCase>(
      () => _i38.DeleteProductUseCase(get<_i22.IProductRepository>()));
  gh.factory<_i39.IGetOrderUseCase>(
      () => _i40.GetOrdersUseCase(get<_i18.IOrderRepository>()));
  gh.factory<_i41.IGetProductUseCase>(
      () => _i42.GetProductUseCase(get<_i22.IProductRepository>()));
  gh.factory<_i43.IGetProductsListUseCase>(
      () => _i44.GetProductsListUseCase(get<_i22.IProductRepository>()));
  gh.factory<_i45.ProductBloc>(() => _i45.ProductBloc(
      getProductUseCase: get<_i41.IGetProductUseCase>(),
      addProductUseCase: get<_i35.IAddProductUseCase>(),
      updateProductUseCase: get<_i26.IUpdateProductUseCase>(),
      deleteProductUseCase: get<_i37.IDeleteProductUseCase>()));
  gh.factory<_i46.ProductsListBloc>(() => _i46.ProductsListBloc(
      productsListUseCase: get<_i43.IGetProductsListUseCase>()));
  gh.factory<_i47.CartBloc>(() => _i47.CartBloc(
      addOrUpdateCartUseCase: get<_i33.IAddOrUpdateCartUseCase>(),
