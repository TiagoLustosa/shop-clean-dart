...
import 'package:shop_clean_arch/app/shop/domain/usecases/product_usecases/update_product_usecase.dart';
...
void main() {
  ...
  final sut = UpdateProductUseCase(productRepositoryMock);
  setUp(() {
    registerFallbackValue(ProductResultModel());
  });

  test('should return a Product entity', () async {
    when(() => productRepositoryMock.updateProduct(any())).thenAnswer(
    ...
    verify(() => productRepositoryMock.updateProduct(any())).called(1);
  });
